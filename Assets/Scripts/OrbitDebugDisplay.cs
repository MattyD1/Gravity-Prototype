...
public class OrbitDebugDisplay : MonoBehaviour {
    ...
    void DrawOrbits () {
        ...
        for (int bodyIndex = 0; bodyIndex < virtualBodies.Length; bodyIndex++) {
            var pathColour = bodies[bodyIndex].gameObject.GetComponent<SpriteRenderer> ().sharedMaterial.color; //
    ...
    Vector3 CalculateAcceleration (int i, VirtualBody[] virtualBodies) {
        ...
        for (int j = 0; j < virtualBodies.Length; j++) {
            ...
            acceleration += forceDir * Universe.gravitationConstant * virtualBodies[j].mass / sqrDst;
        }
        return acceleration;
    }
